...
- (void)viewDidLoad
{
    ...
    settingsTableSections = [NSMutableArray array];
    settingsTableData = [NSMutableArray array];
    settingsKeys = [NSMutableArray array];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    int tag = (int)[settingsKeys count] - 1;
    ...
    if([type isEqualToString: typeMultiValue]) {
        ...
        int index = (int)[values indexOfObject: [NSString stringWithFormat: @"%d", value]];
